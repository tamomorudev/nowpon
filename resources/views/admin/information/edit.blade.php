...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">お知らせ編集</h1>
        </div>
        ...
        <form class="user" method="POST" action="{{ route('admin.information.edit') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="name" class="col-md-4 col-form-label text-md-end">特集名<span class="text-danger">*</span></label>
                <div class="col-sm-10 mb-3 mb-sm-0">
                    <input type="text" class="form-control" name="name"
                           value="{{ old('name', $information_data->name) }}" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-md-4 col-form-label text-md-end">内容<span class="text-danger">*</span></label>
                <div class="col-sm-10 mb-3 mb-sm-0">
                    <textarea id="summernote" class="form-control" rows="10" cols="60" name="detail">{{ old('detail', $information_data->detail) }}</textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="row"style="margin-left:0px">
                    <div class="col-sm-3 mb-3 mb-sm-0">
                        <input type="datetime-local" class="form-control" id="start_date" name="start_date" value="{{ old('start_date', $information_data->start_date) }}">
                    </div>
                    ～
                    <div class="col-sm-3">
                        <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="{{ old('end_date', $information_data->end_date) }}">
                    </div>
                </div>
            </div>
